  ...
  details: {
    ...
    timeline: {
      ...
      ceremony: {
        time: "4:00 PM",
        title: "Ceremony",
        description: "Join us as we exchange vows in an intimate ceremony surrounded by loved ones.",
      },
      cocktailHour: {
        time: "4:30 PM",
        title: "Cocktail Hour",
        description: "Enjoy refreshments and mingle with guests while we capture photos.",
      },
      dinner: {
        time: "5:30 PM",
        title: "Dinner",
        description: "Savor a delicious meal with family and friends as we share stories and laughter.",
      },
      party: {
        time: "6:00 PM",
        title: "Party",
        description: "Celebrate with dinner, toasts, and dancing as we begin our new journey together.",
      },
      sendOff: {
        time: "1:30 AM",
        title: "Send-Off",
        description: "Help us end the night with a magical send-off under the stars.",
      },
    },
  },
  travel: {
...
For quick and comfortable travel, Uber is an excellent option. If you prefer taxis, we recommend using the Flota Bernal app, which is safe and easy to use. For peace of mind, avoid hailing taxis directly on the street.`,
  ...
  faq: {
    ...
    indoorsOutdoorsAnswer: "The ceremony will take place outdoors in the beautiful garden of Fábula Bodas & Eventos, while the dinner and party will be held indoors in the elegant ballroom with an amazing view of the mountains.",
...
Para moverte de forma rápida y cómoda, Uber es una excelente opción. Si prefieres taxi, te recomendamos usar la app Flota Bernal, que es segura y fácil de usar. Evita tomar taxis directamente en la calle para mayor tranquilidad.`,
  ...
  faq: {
    ...
    indoorsOutdoorsAnswer: "La ceremonia tendrá lugar al aire libre en el precioso jardín de Fábula Bodas & Eventos, mientras que la cena y la fiesta se celebrarán en el interior, en el elegante salón con unas vistas impresionantes de las montañas.",
  ...
  details: {
    ...
    timeline: {
      ...
      ceremony: {
        time: "16:00",
        title: "Церемония",
        description: "Присоединяйтесь к нам, когда мы обмениваемся клятвами в интимной церемонии в окружении наших близких.",
      },
      cocktailHour: {
        time: "16:30",
        title: "Коктейль-час",
        description: "Наслаждайтесь напитками и общайтесь с гостями, пока мы делаем фотографии.",
      },
      dinner: {
        time: "17:30",
        title: "Ужин",
        description: "Насладитесь вкусной едой с семьей и друзьями, делясь историями и смеясь вместе.",
      },
      party: {
        time: "18:00",
        title: "Вечеринка",
        description: "Отпразднуйте с ужином, тостами и танцами, когда мы начинаем наш новый путь вместе.",
      },
      sendOff: {
        time: "01:30",
        title: "Проводы",
        description: "Помогите нам завершить вечер волшебными проводами под звездами.",
      },
    },
  },
  travel: {
...
Для быстрого и комфортного передвижения отличным вариантом является Uber. Если предпочитаете такси, рекомендуем приложение Flota Bernal — это безопасно и удобно. Для спокойствия избегайте ловить такси на улице.`,
  ...
  faq: {
    ...
    indoorsOutdoorsAnswer: "Церемония пройдет на открытом воздухе в прекрасном саду Fábula Bodas & Eventos, а ужин и вечеринка - в элегантном зале с удивительным видом на горы.",
  ...
  details: {
    ...
    timeline: {
      ...
      ceremony: {
        time: "16:00 Uhr",
        title: "Trauung",
        description: "Begleitet uns, wenn wir unsere Gelöbnisse in einer intimen Zeremonie im Kreise unserer Liebsten austauschen.",
      },
      cocktailHour: {
        time: "16:30 Uhr",
        title: "Cocktail-Stunde",
        description: "Genießt Erfrischungen und tauscht euch mit den Gästen aus, während wir Fotos machen.",
      },
      dinner: {
        time: "17:30 Uhr",
        title: "Abendessen",
        description: "Schmeckt ein köstliches Essen mit Familie und Freunden, während wir Geschichten teilen und zusammen lachen.",
      },
      party: {
        time: "18:00 Uhr",
        title: "Party",
        description: "Feiert mit Abendessen, Toasten und Tanzen, während wir unsere neue Reise zusammen beginnen.",
      },
      sendOff: {
        time: "01:30 Uhr",
        title: "Verabschiedung",
        description: "Helft uns, die Nacht mit einem magischen Abschied unter den Sternen zu beenden.",
      },
    },
  },
  travel: {
...
Für schnelle und bequeme Fahrten ist Uber eine ausgezeichnete Option. Wenn Sie lieber ein Taxi nehmen, empfehlen wir die App Flota Bernal, die sicher und einfach zu bedienen ist. Um auf der sicheren Seite zu sein, vermeiden Sie es, Taxis direkt auf der Straße anzuhalten.`,
  ...
  faq: {
    ...
    indoorsOutdoorsAnswer: "Die Zeremonie findet im schönen Garten von Fábula Bodas & Eventos statt, während das Abendessen und die Party im eleganten Ballsaal im Inneren stattfinden. Beide Räume sind klimatisiert für Ihren Komfort.",
